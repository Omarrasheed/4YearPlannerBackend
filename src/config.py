...
# Database info
DB_USERNAME  = os.environ['PLANNER_DB_USERNAME']
DB_PASSWORD  = os.environ['PLANNER_DB_PASSWORD']
DB_HOST      = os.environ['PLANNER_DB_HOST']
DB_NAME      = os.environ['PLANNER_DB_NAME']
